A sample ICD10CM lookup using the API from https://clinicaltables.nlm.nih.gov/api/conditions/v3/search?terms=${encodedCondition}&sf=consumer_name&ef=icd10cm_codes,icd10cm
